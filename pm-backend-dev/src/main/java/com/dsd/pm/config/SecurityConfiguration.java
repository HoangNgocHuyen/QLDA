...
import com.dsd.pm.security.jwt.JWTConfigurer;
import com.dsd.pm.security.jwt.TokenProvider;
...
//            .antMatchers("/api/admin/**").hasAuthority(AuthoritiesConstants.ADMIN)
            .antMatchers("/api/pm/download/**").permitAll()
            .antMatchers("/api/pm/delete/**").permitAll()
